...
#python combined_cv_train.py --model effnet --dataset IPI_removed
#python combined_cv_train.py --model passt --dataset with_IPI
#python combined_cv_train.py --model passt --dataset IPI_removed --no-grid
...
class BaseFinetuner(pl.LightningModule):
    def __init__(self, n_classes: int, cfg: dict, fold_idx: int):
        super().__init__()
